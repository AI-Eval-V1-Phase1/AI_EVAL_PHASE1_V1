...
<style>
  ...
  .confirm-button { background-color: #1e3a8a; color:white; padding:14px 28px; border-radius:6px; text-decoration:none; font-weight:bold; display:inline-block; }
...
<div class="container">
  ...
  <p>You requested a password reset for your AI Eval account. Click the button below to choose a new password.</p>
