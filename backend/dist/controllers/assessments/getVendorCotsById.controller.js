...
const getVendorCotsById = async (req, res) => {
    try {
        ...
        const orgId = String(user.organization_name ?? "").trim();
        if (!orgId)
        ...
        const toJson = (v) => v != null ? (Array.isArray(v) ? v : typeof v === "object" ? JSON.stringify(v) : String(v)) : "";
        const data = {
            ...
            productFeatures: r.product_features != null
            ...
            regulatoryRequirements: r.regulatory_requirements != null
            ...
            customerSpecificRisks: r.customer_specific_risks != null
